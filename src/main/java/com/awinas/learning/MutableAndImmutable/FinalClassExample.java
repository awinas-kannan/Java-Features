...
//		this.testMap = tempMap;
		...
		//Since both String, String are immutable no problem with cloning
		//if Its like HashMap<String, Employee> .. then it will be a problem
		//map.get(1).setName("awi").. will change the values
		//Ref JavaHashMapCloningExample.java
	}
