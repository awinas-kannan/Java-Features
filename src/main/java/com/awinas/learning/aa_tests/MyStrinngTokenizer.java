package com.awinas.learning.aa_tests;

import java.util.Arrays;
import java.util.StringTokenizer;

public class MyStrinngTokenizer {
	public static void main(String[] args) {
		...
		while (userInformations.hasMoreTokens()) {
			...
			if (!userInformationsForBank.startsWith("GBS05349")) {
				...
				System.out.println(Arrays.toString(informations));
//				Society society = new Society(informations[1]!=null ? Long.valueOf(informations[1].trim()) : -1, informations[2]!=null ? informations[2].trim() : null);
